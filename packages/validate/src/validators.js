...
export const disabledDates = (value, isDisabledFn) => isDisabledFn(value);
export const disabledDatesValidator = (...factoryParams) => [
  (...params) => ({ disabledDates: disabledDates(...params) }),
  ...factoryParams,
];
