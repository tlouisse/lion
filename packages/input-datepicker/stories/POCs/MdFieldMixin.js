    ...
    class extends superclass {
      static get styles() {
        ...
        {element} .form-field__label  */
            ...
            :host(.state-disabled) .form-field__label ::slotted(label) {
        ...
        {element} .form-field__help-text  */
            ...
            :host(.state-focused) .form-field__help-text {
              visibility: visible;
            }

            :host(.state-error-show) .form-field__help-text {
              display: none;
            }
        ...
        {element} .md-input__underline */
            ...
            :host(.state-disabled) .md-input__underline {
        ...
        {element} .md-input__underline-ripple */
            ...
            :host(.state-focused) .md-input__underline-ripple {
              visibility: visible;
              opacity: 1;
              transform: scaleX(1);
